#!/usr/bin/env node
/**
 * Генерирует случайные API_TOKEN и ADMIN_PASSWORD для вставки в Railway или в .env
...
console.log(block);
console.log('---\nСохраните ADMIN_PASSWORD в надёжном месте; он показывается один раз в консоли.\n');
